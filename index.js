/*------------------------------------*/ 
/* javascript 3rd assaignment resourse */    
/*------------------------------------ */
...
var productList = [
  ...
  /************************* *********/
  /* code for assaingnment solution */
  /******************************** */

  console.log("script working successfull");

  let cloth_main_wrapper = document.createElement("div");
  document.body.append(cloth_main_wrapper);
  cloth_main_wrapper.setAttribute("class","cloth_main_wrapper");
  
  
  //---------- code for clothing heading------//
 
  let cloth_id = document.createElement("div");
  // document.body.append(cloth_id);
  cloth_id.setAttribute("id","cloth-heading");
  cloth_main_wrapper.append(cloth_id);
 
  
  let cloth_heading = document.createElement("h2");
  cloth_id.append(cloth_heading);
  cloth_heading.innerHTML="Clothing for Men and Women";

  /*------------ code for wrapper -------------*/
  let wrapper = document.createElement("div");
  cloth_main_wrapper.append(wrapper);
  wrapper.setAttribute('id','clothing-section');
  ...
  let main_container = document.createElement("div"); // main wrapper
  wrapper.append(main_container);
  main_container.setAttribute("class","main-container")
  
  let  link = document.createElement("a"); // to make link
  link.setAttribute('href','#');
  main_container.append(link);
  
  /*----------- code for image section -----*/
  let image_container = document.createElement("div");
  let image = document.createElement("img");
  image_container.append(image);
  image.setAttribute('class','our-image')
  image.src = productList[i].preview;
  image_container.setAttribute("class","image-section")

  link.append(image_container);

  /**--------- code for details section------------ */
  let detail_container = document.createElement("div");
  detail_container.setAttribute("calss","detail-section");
  let detail_name = document.createElement("div");
  detail_name.setAttribute("class","product-name");
  detail_container.append(detail_name);
  let productName = document.createElement("P"); // for product name
  detail_name.append(productName);
  productName.innerHTML = productList[i].name;
  let brand_container = document.createElement("div");
  detail_container.append(brand_container);
  brand_container.setAttribute("class","brand-class");
  let productBrand = document.createElement("h5"); // for brand 
  brand_container.append(productBrand);
  productBrand.innerHTML = productList[i].brand;
  let price_container = document.createElement("div");
  price_container.setAttribute("class","price-class")
  detail_container.append(price_container);
  let productPrice = document.createElement("h5"); // for price
  price_container.append(productPrice);
  productPrice.innerHTML = 'Rs' + ' ' + productList[i].price;

  link.append(detail_container);
    }
  }
...
/********************************************************** */
/**################# code for Accessories section  ######  */
/********************************************************* */
let Access_main_wrapper = document.createElement("div");
document.body.append(Access_main_wrapper);
Access_main_wrapper.setAttribute("class","Access_main_wrapper");

 //---------- code for Accessories heading------//
 
 let Access_id = document.createElement("div");
 // document.body.append(cloth_id);
 Access_id.setAttribute("id","access-heading");
 Access_main_wrapper.append(Access_id);

 
 let Access_heading = document.createElement("h2");
 Access_id.append(Access_heading);
 Access_heading.innerHTML="Accessories for Men and Women";

  /*------------ code for Accessories wrapper -------------*/
  let Access_wrapper = document.createElement("div");
  Access_main_wrapper.append(Access_wrapper);
  Access_wrapper.setAttribute('id','Accessories-section');
  ...
  /************ code for card container ************  */
  let Access_main_container = document.createElement("div"); // main wrapper
  Access_wrapper.append(Access_main_container);
  Access_main_container.setAttribute("class","main-container")
  
  let  linkA = document.createElement("a"); // to make link
  linkA.setAttribute('href','#');
  Access_main_container.append(linkA);

   /*----------- code for image section -----*/
   let Access_image_container = document.createElement("div");
   let Access_image = document.createElement("img");
   Access_image_container.append(Access_image);
   Access_image.setAttribute('class','our-image')
   Access_image.src = productList[i].preview;
   Access_image_container.setAttribute("class","image-section")
 
   linkA.append(Access_image_container);


   /**--------- code for details section------------ */
  let Access_detail_container = document.createElement("div");
  Access_detail_container.setAttribute("calss","detail-section");
  let Access_detail_name = document.createElement("div");
  Access_detail_name.setAttribute("class","product-name");
  Access_detail_container.append(Access_detail_name);
  let Access_productName = document.createElement("P"); // for product name
  Access_detail_name.append(Access_productName);
  Access_productName.innerHTML = productList[i].name;
  let Access_brand_container = document.createElement("div");
  Access_detail_container.append(Access_brand_container);
  Access_brand_container.setAttribute("class","brand-class");
  let Access_productBrand = document.createElement("h5"); // for brand 
  Access_brand_container.append(Access_productBrand);
  Access_productBrand.innerHTML = productList[i].brand;
  let Access_price_container = document.createElement("div");
  Access_price_container.setAttribute("class","price-class")
  Access_detail_container.append(Access_price_container);
  let Access_productPrice = document.createElement("h5"); // for price
  Access_price_container.append(Access_productPrice);
  Access_productPrice.innerHTML = 'Rs' + ' ' + productList[i].price;

  linkA.append(Access_detail_container);
    }
  }
